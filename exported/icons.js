// Lucide icons converted to SVG strings
const icons = {
...
// Replace icon placeholders with SVG content
document.querySelectorAll('.icon-home').forEach(el => el.innerHTML = icons.home);
document.querySelectorAll('.icon-mail').forEach(el => el.innerHTML = icons.mail);
document.querySelectorAll('.icon-settings').forEach(el => el.innerHTML = icons.settings);
document.querySelectorAll('.icon-menu').forEach(el => el.innerHTML = icons.menu);